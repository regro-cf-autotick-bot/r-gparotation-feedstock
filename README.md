...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-gparotation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-gparotation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-gparotation
# for installing globally
pixi global install r-gparotation
```
...
It is possible to list all of the versions of `r-gparotation` available on your platform:
...
```
pixi search r-gparotation --channel conda-forge
```
